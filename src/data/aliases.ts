...
export const ALIASES: Record<string, string[]> = {
  'Times Sq-42 St':                      ['Times Square', 'Times Sq', '42nd St'],
  ...
  '34 St-Penn Station':                  ['Penn Station', 'Penn', '34th St Penn', '34 St'],
  '34 St-Herald Sq':                     ['Herald Square', 'Herald Sq', '34 St Herald', '34 St'],
  '14 St-Union Sq':                      ['Union Square', 'Union Sq', '14 St Union'],
  '59 St-Columbus Circle':               ['Columbus Circle', '59th St', '59 St Columbus'],
  '68 St-Hunter College':                ['68 St', 'Hunter College'],
  'Fulton St':                           ['Fulton Street', 'Fulton'],
  '42 St-Bryant Pk':                     ['Bryant Park', 'Bryant Pk', '42 St Bryant'],
  ...
  'Bedford-Nostrand Avs':                ['Bedford Nostrand'],
  ...
  'Jackson Hts-Roosevelt Av':            ['Jackson Heights', 'Roosevelt Ave'],
  ...
  '116 St-Columbia University':          ['Columbia', 'Columbia University'],
  '137 St-City College':                 ['City College'],
  'Marble Hill-225 St':                  ['Marble Hill', '225 St'],
  'Christopher St-Stonewall':            ['Christopher St', 'Sheridan Square', 'Sheridan Sq'],
  ...
  '15 St-Prospect Park':                 ['15 St Prospect Park', 'Prospect Park 15', 'Prospect Park'],
  ...
  'Aqueduct-N Conduit Av':               ['Aqueduct', 'North Conduit'],
  ...
  'Newkirk Av-Little Haiti':             ['Newkirk Ave', 'Newkirk Av', 'Little Haiti'],
  ...
  '231 St':                              ['231st St'],
  '238 St':                              ['238th St'],
  'Van Cortlandt Park-242 St':           ['242 St', '242nd St', 'Van Cortlandt Park'],
  '14 St':                               ['14th St'],
  '23 St':                               ['23rd St'],
  '28 St':                               ['28th St'],
  '33 St':                               ['33rd St'],
  ...
  'Bedford Pk Blvd-Lehman College':     ['Bedford Park', 'Bedford Park Blvd', 'Bedford Park Boulevard', 'Bedford Pk', 'Lehman', 'Lehman College'],
  'Bedford Pk Blvd':                    ['Bedford Park', 'Bedford Park Blvd', 'Bedford Park Boulevard', 'Bedford Pk'],
}
